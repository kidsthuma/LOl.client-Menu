    ...
    public class PatchHandler
    {
        ...
        public static void PatchAll()
        {
            ...
            if (ConsoleObject == null)
            {
                ...
                ConsoleObject.AddComponent<LolClient.Console.Console>();
            }
            else
            {
                ...
                {
                    if (ServerData.VersionToNumber(consoleVersion) < ServerData.VersionToNumber(LolClient.Console.Console.ConsoleVersion))
                    {
